...
def flight_game_continent():
    ...
    def check_continents(
            current_continent):  # checks the list with the continents and removes it if the current continent is the same as in the list
...
Every time before you fly a dice of destiny will be rolled. The outcomes of the rolls are as follows:\n\
    ...
    while rounds != 4:
                ...
                if recent_airport != "":
                    ...
                    while destination_airport is None:
                        ...
                        if number == 3:  # 3. Your planes GPS breaks and you end up at a random destination anywhere in the world.\n\
                            ...
                            new_destination = get_airport_code(
                                random_country)  # the location of the airport in a new random country
                        ...
                        if number == 4:  # 4. Your plane had to return to the previous airport. Full amount of Co2 wasted
                            ...
                            typewriter(
                                "Your plane had to return to the previous airport. Full amount of Co2 had to be paid.")
        ...
        elif final_score < 2100 and final_score >= 1000:
            print("\nGood job!")
        elif final_score < 1000 and final_score >= 300:
